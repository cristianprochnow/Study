...
<head>
	...
	<link
		rel="stylesheet"
		href="<?php echo base_url();?>assets/css/simplePagination.css"
		class="theme-stylesheet"
	/>
	...
	<body class="no-skin">
						...
						<li class="light-blue">
							...
							>
								<img
									...
									src="<?php echo base_url();?>assets/avatars/user.jpg"
									alt="Admin Photo"
								/>
				...
				<div class="footer-inner">
					<div class="footer-content">
						<span class="bigger-120">
							...
							phpflow.com. All rights reserved.
						</span>
					</div>
				</div>
			</div>
		...
		<script 
			src="<?php echo base_url();?>assets/js/ace.min.js"
		></script>
		<script
			src="<?php echo base_url();?>assets/js/jquery.simplePagination.js"
		></script>
	</body>
</html>
