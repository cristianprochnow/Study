...
<head>
	...
	<link rel="stylesheet" href="<?php echo base_url();?>assets/css/simplePagination.css" class="theme-stylesheet"/>
			...
			<div class="footer">
				<div class="footer-inner">
					<div class="footer-content">
						<span class="bigger-120"> Copyright &copy; phpflow.com. All rights reserved. </span>
					</div>
				</div>
			</div>
