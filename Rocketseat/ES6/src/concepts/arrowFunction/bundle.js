 ...
 */
var randomArray = [1, 4, 7, 9, 2, -2];

var _double = randomArray.map(function (item) {
  return item * 2;
});
...
var shortDouble = randomArray.map(function (item) {
  return item * 2;
});
...
var nomeFuncao = function nomeFuncao() {}; // Mas não é indicado fazer isso
...
var correctExample = function correctExample() {
  return {
    nome: 'Cristian'
  };
};
